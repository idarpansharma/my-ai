...
- `web_search(query: str, num_results: int = 50)`: Searches the web for a given query. IMPORTANT: This tool can only return a maximum of 50 results due to API limitations. It returns a synthesized answer based on the top results. Use for current events, facts, or general knowledge.
