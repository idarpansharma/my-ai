...
- `web_search(query: str, num_results: int = 10)`: Searches the web for the given query and returns a synthesized answer based on the top results. Use for current events, facts, or general knowledge.
